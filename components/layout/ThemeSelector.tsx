    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          style={{
            backgroundColor: mode === "dark" ? "var(--theme-primary)" : "var(--theme-border)",
          }}
        >
          <div
            ...
            style={{
              transform: mode === "dark" ? "translateX(30px)" : "translateX(4px)",
            }}
          >
            {mode === "dark" ? (
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          <Palette size={16} style={{ color: "var(--theme-text-secondary)" }} />
          <span className="text-sm font-medium" style={{ color: "var(--theme-text)" }}>
            Color Theme
          </span>
        </div>
          ...
          {themeOptions.map((theme) => {
            ...
            return (
              <button
                ...
                style={{
                  borderColor: isActive ? colors.primary : "var(--theme-border)",
              ...
              >
                ...
                <h3
                  ...
                  style={{ color: isActive ? colors.primary : "var(--theme-text)" }}
                >
                  {theme.name}
                </h3>
