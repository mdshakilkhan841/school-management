...
const GradeForm = ({
    ...
    return (
        <form className="flex flex-col gap-4" onSubmit={onSubmit}>
            ...
            {state.error && (
                <p className="text-red-500 text-xs text-center">Something went wrong! Level/Name must be unique.</p>
            )}
            <button className="bg-blue-400 text-white p-3 rounded-md mt-2 font-medium">
                {type === "create"
